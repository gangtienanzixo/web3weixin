...
namespace Seebon.Weixin.MP.MvcExtension.Results
{
    ...
    public class WeixinResult : ContentResult
    {
        ...
        public override void ExecuteResult(ControllerContext context)
        {
            if (base.Content == null)
            {
                ...
                {
                    throw new Seebon.Weixin.MP.WeixinException("执行WeixinResult时提供的MessageHandler不能为Null！", null);
                }

                if (_messageHandler.ResponseMessage == null)
                {
                    throw new Seebon.Weixin.MP.WeixinException("ResponseMessage不能为Null！", null);
                }
