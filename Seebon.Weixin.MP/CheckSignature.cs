...
namespace Seebon.Weixin.MP
{
    public class CheckSignature
    {
        ...
        /// </summary>
        public const string Token = "seebon61138828";
        ...
        {
            using (TextWriter tw = new StreamWriter(System.Web.HttpContext.Current.Server.MapPath("~/App_Data/Record_" + DateTime.Now.Ticks + ".txt")))
            {
                tw.WriteLine("ExecptionMessage:" + strMsg);
